          ...
          {items.map((item, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                {/* Eliminar — visible siempre, más opaco por defecto, aparece al hover */}
                <button
                  type="button"
                  disabled={disabled}
                  onClick={() => onRemove(item.productId)}
                  className="p-2 text-red-500 transition-colors hover:text-red-600 group-hover:text-slate-400"
                >
